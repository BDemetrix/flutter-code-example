...
import '../../bloc/contacts/contacts_state.dart';
import '../../widgets/contacts/abonent_item.dart';
import '../../widgets/contacts/group_item.dart';
...
class ContactsView extends StatelessWidget {
  ...
  void _onGroupTap(BuildContext context, Group group) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('Выбрана группа: ${group.name}')),
    );
  }
  ...
  void _onContactTap(BuildContext context, Abonent contact) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('Выбран абонент: ${contact.name}')),
    );
  }
}
